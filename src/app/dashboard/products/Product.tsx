...
const Product: React.FC<DashboardProductProps> = ({ product }) => {
  ...
  return (
    <div className="bg-background flex flex-col border border-muted rounded-xl shadow-sm relative font-sans transition-shadow duration-200 hover:shadow-md group">
      <div className="flex-1">
        ...
        <div className="p-2">
          ...
          <p className="mb-3 line-clamp-2 font-sans text-sm text-muted-foreground leading-relaxed">
            {product.desc}
          </p>
        </div>
      </div>
