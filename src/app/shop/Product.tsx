    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="flex-1 flex flex-col">
          <div className="p-4 space-y-2 flex-1 border-b border-muted">
              ...
              <div className="flex gap-1">
                {range(1, 5).map((star) => (
                  <Star
                    ...
                    className={cn(
                      "transition-colors",
                      star <= product.rate.average ? "fill-accent text-accent" : "text-muted"
                    )}
                  />
                ))}
              </div>
              <span className="font-sans text-sm text-foreground">({product.rate.count} reviews)</span>
            </div>
